// Completed fights — this is the original fight page, unchanged. Upcoming fights
// get the matchup dashboard in UpcomingFightPage; FightDetailPage picks between
// them. This page is slated for its own redesign, so it has deliberately not been
// restyled onto the viz tokens the dashboard uses.
...
import ShapBar from '../components/viz/ShapBar'
...
// `fight` is already loaded — FightDetailPage does the fetching and routes the
// payload here or to UpcomingFightPage depending on whether a winner is recorded.
export default function CompletedFightPage({ fight }) {
